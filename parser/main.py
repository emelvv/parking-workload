...
DISTANCE_PRICE_BRACKETS: Tuple[Tuple[float, int], ...] = (
    (2.0, 800),   # Центральные улицы и внутри Бульварного кольца
    (5.0, 400),   # В пределах Садового кольца
    (8.0, 250),   # Между Садовым и Третьим транспортным
    (15.0, 150),  # Внутри МКАД (плотная застройка)
    (25.0, 100),  # Отдалённые районы внутри МКАД
)
